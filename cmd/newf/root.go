...
func newRootCommand(stdout io.Writer, app *pipeline.App, opts *rootOptions, version string) *cobra.Command {
	...
	cmd.AddCommand(newExperimentCommand(stdout, app, opts))
	cmd.AddCommand(newEvaluateCommand(stdout, app, opts))
	cmd.AddCommand(newEvaluationCommand(stdout, app, opts))
	cmd.AddCommand(newEvidenceCommand(stdout, app, opts))
	cmd.AddCommand(newProjectionCommand(stdout, app, opts))
	cmd.AddCommand(newCompositionCommand(stdout, opts))
	...
	cmd.AddCommand(newG4Command(stdout, opts))
