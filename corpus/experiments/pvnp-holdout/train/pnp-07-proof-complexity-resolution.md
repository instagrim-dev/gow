  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": ["propositional proof systems", "resolution refutations", "tautology families"],
        "assumptions": ["per-system lower bounds accumulate toward all-systems hardness", "width/bottleneck properties certify proof size"],
        "operators": ["bottleneck counting", "width lower bounds", "restriction on proofs"],
        ...
        "auxiliary_objects": ["pigeonhole tautologies", "proof-width measure"],
        "locality": "local",
