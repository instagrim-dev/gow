<!-- train-source: es-01-mordell-polynomial-identities.md -->
...
<!-- train-source: es-02-covering-system-attempt.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        ...
        "assumptions": [
          "finite covering suffices",
          "identities compose across classes"
        ],
        "operators": [
          "congruence covering",
          "class union"
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue primes",
          "no guaranteed 2-fraction representation there"
        ],
...
<!-- train-source: es-03-factorization-scheme.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "divisor factorizations",
          "nonlinear parameterization"
        ],
        "assumptions": [
          "suitable divisor exists",
          "positivity via local filters"
        ],
        "operators": [
          "divisor enumeration",
          "local congruence filter",
          "factorization identity"
        ],
        "preserves": [
          "local divisor structure"
        ],
        "breaks": [],
        "auxiliary_objects": [
          "divisor lattice of an n-dependent quantity"
        ],
        "locality": "local",
        "construction_mode": "constructive",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "a prime lacking both Type A and Type B would be a counterexample",
...
<!-- train-source: es-04-type-i-ii-classification.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "solution divisibility types",
          "divisor sums"
        ],
        "assumptions": [
          "n prime restricts to two types"
        ],
        "operators": [
        ...
        "preserves": [
          "solution divisibility invariants"
        ],
        "breaks": [
          "classification by producing congruence"
        ],
        "auxiliary_objects": [
          "Type I and Type II solution counts"
        ],
        "locality": "mixed",
        "construction_mode": "existential",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue primes",
          "existence not implied by classification"
        ],
...
<!-- train-source: es-05-averaging-bombieri-vinogradov.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "solution-count function f(n)",
          "average over primes"
        ],
        "assumptions": [
          "ensemble averaging is informative",
          "sieve estimates apply"
        ],
        "operators": [
          "averaging",
          "sieve estimation",
        ...
        "preserves": [
          "mean solution density"
        ],
        "breaks": [
          "per-n constructivity"
        ],
        "auxiliary_objects": [
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "n a quadratic residue to small moduli",
          "n = 1 mod 24 survivors"
        ],
...
<!-- train-source: es-06-two-fraction-representation-bounds.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "two-unit-fraction representations",
          "divisor counts"
        ],
        "assumptions": [
          "fixing one denominator is without loss",
          "divisor counts control existence"
        ],
        "operators": [
          "reduction to two fractions",
          "representation counting"
        ],
        "preserves": [
          "existence via representation lower bounds"
        ],
        "breaks": [],
        "auxiliary_objects": [
          "representation-count estimates for a/b = 1/y + 1/z"
        ],
        "locality": "global",
        "construction_mode": "existential",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue primes",
          "existence not gained by lifting"
        ],
...
<!-- train-source: es-07-computational-verification.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "explicit solved instances",
          "search over denominators"
        ],
        "assumptions": [
          "finite range is checkable",
          "multiplicative reduction to primes"
        ],
        "operators": [
          "bounded search",
          "sieving",
        ...
        "preserves": [
          "certified per-instance solutions"
        ],
        "breaks": [
          "claim of generality"
        ],
        "auxiliary_objects": [
          "verification range bound",
...
<!-- train-source: es-08-quadratic-reciprocity-obstruction.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        ...
        "assumptions": [
          "identity methods reduce to congruence relations"
        ],
        "operators": [
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "infinitely many QR primes beyond the bound"
        ],
...
<!-- train-source: es-09-higher-dimensional-variety-lift.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        ...
        "assumptions": [
          "parameterizations are slices of one object",
          "lift preserves solution sets"
        ],
        "operators": [
          "algebraic lift",
          "re-representation",
        ...
        "preserves": [
          "solution sets of unified parameterizations"
        ],
        "breaks": [
          "surface distinctions between parameterizations"
        ],
        "auxiliary_objects": [
          "unifying variety"
        ],
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue primes",
          "divisor search may fail to certify"
        ],
...
<!-- train-source: es-10-vaughan-congruence-density.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        ...
        "assumptions": [
          "many classes admit identities",
          "leftover is boundable"
        ],
        "operators": [
          "class assembly",
          "density estimation"
        ...
        "preserves": [
          "solvability on the assembled classes"
        ],
        "breaks": [],
        "auxiliary_objects": [
          "exceptional-set density bound"
        ],
        "locality": "mixed",
        "construction_mode": "existential",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue survivor classes",
          "density never reaches zero"
        ],
...
<!-- train-source: es-11-monks-velingker-structure.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "solution-set relations",
          "denominator symmetries"
        ],
        "assumptions": [
          "structural constraints link residue classes"
        ],
        "operators": [
        ...
        "preserves": [
          "algebraic relations among denominators"
        ],
        "breaks": [],
        "auxiliary_objects": [
          "induced-solution maps between related n"
        ],
        "locality": "mixed",
        "construction_mode": "existential",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "rare primes could have zero solutions",
          "quadratic-residue primes"
        ],
...
<!-- train-source: es-12-type-a-b-congruence-system.md -->
  ...
  "approaches": [
    {
      ...
      "mechanism": {
        "representations": [
          "Type A/B solution forms",
          "congruence system",
          "general polynomials"
        ],
        "assumptions": [
          "forms cover all primes",
          "admitted congruences avoid quadratic residues"
        ],
        "operators": [
          "form classification",
        ...
        "preserves": [
          "Mordell non-residue restriction",
          "polynomial-identity solvability per form"
        ],
        "breaks": [
          "classification by producing congruence"
        ],
        "auxiliary_objects": [
          "Type A congruence+polynomial",
          "Type B congruence+polynomial"
        ],
        "locality": "global",
        "construction_mode": "constructive",
        "uncertainty_mode": "deterministic",
      ...
      "outcome": {
        ...
        "boundary_conditions": [
          "quadratic-residue survivor classes",
          "infinitely many survivor primes"
        ],
