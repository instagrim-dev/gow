...
supersedes: CUSTODIAN_INTERFACE_BRIEF_V3.md; CUSTODIAN_INTERFACE_BRIEF.md remains the frozen attempt-4 interface
---

# Custodian interface brief v4
...
actions, and the return-packet digest. It must not disclose case inputs, answers, raw outputs, case-specific outcomes, or scores. It may disclose only the content-free aggregate coverage fields required by the paired v4 return packet.
