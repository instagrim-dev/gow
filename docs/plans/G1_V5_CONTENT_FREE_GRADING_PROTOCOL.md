...
status: prepared_for_operator-authorized-v5-dispatch
prepared_date_utc: '2026-09-14'
scope: G1 v5 content-free return packet only
---

# G1 v5 content-free grading protocol

Grade a returned `g1-v5-return-packet/1` only against the frozen dispatch
...
wrong, a route total is wrong, provider spend/calls are reported above zero,
the packet records an access or authority breach, or a G1 `blocked` count has
a semantic/non-infrastructure blocker category. Return
...
content-free field is absent. Otherwise apply the acceptance matrix and the v5
