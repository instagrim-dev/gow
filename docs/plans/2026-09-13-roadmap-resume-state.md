...
| G4 | The private V1 dispatch is retained `invalid` for frozen-controller identity nonconformance; its saturated 24/24/24 completion counts are a ceiling diagnostic | No new population-level or shaping-value claim | Open sensitivity calibration and runtime-identity preflight, then a successor design with fresh families, complete costs, and authorization |
