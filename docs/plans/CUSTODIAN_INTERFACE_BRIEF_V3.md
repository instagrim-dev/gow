...
supersedes: none; CUSTODIAN_INTERFACE_BRIEF.md remains the frozen attempt-4 interface
---

# Custodian interface brief v3
...
actions, and the return-packet digest. It must not disclose case inputs,
answers, raw outputs, or aggregate scores outside the recipient channel.
